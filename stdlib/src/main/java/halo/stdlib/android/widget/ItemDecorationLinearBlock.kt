...
class ItemDecorationLinearBlock private constructor(builder: Builder) : RecyclerView.ItemDecoration() {
    ...
    override fun getItemOffsets(outRect: Rect?, view: View?, parent: RecyclerView?, state: RecyclerView.State?) {
        val position = parent?.getChildAdapterPosition(view).orDefault(-1)// item position
        outRect?.run {
            left = 0
            right = 0
            top = 0
